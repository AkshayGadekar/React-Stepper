...
const validationSchema = Yup.object().shape({
  business_address: Yup.string().nullable().max(50, "Maximum 50 characters"),
      ...
      <Grid container spacing={4} alignItems="flex-end">
        ...
        >
          <TextField
            ...
            helperText={
              formik.touched.city_state && (formik.errors.city_state as string)
            }
          >
        ...
        <Grid item md={6} width="100%">
          <FieldLabel
            primaryLabel={
              <>
                Primary business phone: <Required />
              </>
            }
